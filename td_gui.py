...
class Ui_TapeDriveWindow(object):
    def setupUi(self, TapeDriveWindow):
        ...
        self.label_mr.setGeometry(QtCore.QRect(310+35+xmov, 85, 100, 40))
		...
		# Main Field Ramp Setpoint Label
        self.label_mramp = QtWidgets.QLabel(self.centralwidget)
        self.label_mramp.setGeometry(QtCore.QRect(210+35+xmov, 85, 100, 40))
        self.label_mramp.setStyleSheet("QLabel {font-size: 12px; color: black; border-radius: 5px;}")
        self.label_mramp.setAlignment(QtCore.Qt.AlignCenter)
        self.label_mramp.setObjectName("label_mramp")
        # PS1 Label
...
=======
>>>>>>> 0e2d7bb0e33a4206d7f5e6131fed904b695c9427
        ...
        self.ps1rampspinBox.setGeometry(QtCore.QRect(210+35+xmov, 130, 100, 40))
        ...
        self.ps1rampspinBox.setKeyboardTracking(False)
        self.ps1rampspinBox.setMinimum(-1.0)
        self.ps1rampspinBox.setMaximum(1.0)
        self.ps1rampspinBox.setProperty("value", 0.0)
        self.ps1rampspinBox.setObjectName("ps1rampspinBox")
        # Power Supply Readout 1
        self.ps1readspinBox = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.ps1readspinBox.setGeometry(QtCore.QRect(310+35+xmov, 130, 100, 40))
        ...
        self.ps2rampspinBox.setGeometry(QtCore.QRect(210+35+xmov, 180, 100, 40))
        ...
        self.ps2rampspinBox.setKeyboardTracking(False)
        self.ps2rampspinBox.setMinimum(-1.0)
        self.ps2rampspinBox.setMaximum(1.0)
        self.ps2rampspinBox.setProperty("value", 0.0)
        self.ps2rampspinBox.setObjectName("ps2rampspinBox")
        # Power Supply Readout 2
        self.ps2readspinBox = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.ps2readspinBox.setGeometry(QtCore.QRect(310+35+xmov, 180, 100, 40))
        ...
        self.ps1Out.setGeometry(QtCore.QRect(420+35+xmov, 130, 120, 40))
        ...
        self.ps2Out.setGeometry(QtCore.QRect(420+35+xmov, 180, 120, 40))
    ...
    def retranslateUi(self, TapeDriveWindow):
        ...
        self.label_mramp.setText(_translate("TapeDriveWindow", "Ramp\nRate (A/s)"))
